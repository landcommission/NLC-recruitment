                                        ...
                                        <ItemTemplate>
                                            <div class="row">
                                                <div class="form-group">
                                                    <span class="control-label col-md-7">Do you have this Qualification?</span>
                                                    <div class="col-md-5">
                    ...
                    <div class="table-responsive">
                        <asp:GridView ID="gridMyApplications" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                               ...
                               <asp:BoundField DataField="DateApplied" DataFormatString="{0:dd-MMM-yyyy}" HeaderText="Date Applied"></asp:BoundField>
